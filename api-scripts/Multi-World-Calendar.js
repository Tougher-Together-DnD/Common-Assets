...
var Calendar = Calendar || (function() {
    ...
    calmenu = function() {
        ...
        sendChat('Calendar', '/w gm <div ' + divstyle + '>' + //--
            ...
            '<div ' + arrowstyle + '></div>' + //--
            '<table ' + tablestyle + '>' + //--
            '<tr><td ' + tdstyle + '>World: </td><td ' + tdstyle + '><a ' + astyle1 + '" href="!setworld,?{World?|Faerûn,1|Greyhawk,2|Modern,3|Eberron,4|Tal\'Dorei,5|Green Isles,6}">' + world + '</a></td></tr>' + //--
    ...
    getMoMenu = function() {
        ...
        switch(world){
            case 1:
                if(leap==0){
                    moMenu = ',?{Month|Birch|Rowan|Imbolc Festival|Ash|Alder|Willow|Beltaine Festival|Hawthorn|Oak|Holly|Lughnasa|Hazel|Ivy|Reed|Samhain Festival|Elder}">';
                }else{
                    moMenu = ',?{Month|Birch|Rowan|Imbolc Festival|Ash|Alder|Willow|Beltaine Festival|Aban Artur Leap Day|Hawthorn|Oak|Holly|Lughnasa|Hazel|Ivy|Reed|Samhain Festival|Elder}">';
                }
                break;
            case 2:
    ...
    getFaerunArray = function(array) {
        ...
        switch(array) {
            case 'array1':
                moonArray = '0,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,4,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,10,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10';
                break;
            case 'array2':
