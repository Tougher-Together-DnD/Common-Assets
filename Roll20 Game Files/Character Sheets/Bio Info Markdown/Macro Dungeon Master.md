...
<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" alt="Spacer to push markdown past avatar." height="0">
...
* Ability-Check *
* Apply-Conditions-Short <sup>[7](#tokenmod)</sup>
* Apply-Spells-Short<sup>7</sup>
* Apply-Status-Short<sup>7</sup>
* Calendar<sup>5</sup>
* Carry-Tokens-Menu<sup>1</sup>
* Combat-Master-Menu<sup>2</sup><sup></sup>
* Combat-Master-Next-Turn<sup></sup><sup></sup>
* Damage-Target<sup></sup>
* Damage-Six-Targets<sup></sup>
* Heal-Target<sup></sup>
* Magic-Store-Menu<sup></sup>
* Make-Default-Token<sup></sup>
* NPC-Info
* PC-Info
* Quick-Calculator
* Resize-Full<sup></sup>
...
* Skill-Check *
* Special-Effect
* Teleport-Menu<sup></sup>
* Whisper-Target-Token

Required API:
<b id="carrytokens">[7]:</b> CarryTokens <https://github.com/Roll20/roll20-api-scripts/tree/master/CarryTokens>
<b id="combatmaster">[7]:</b> CombatMaster <https://github.com/Roll20/roll20-api-scripts/tree/master/CombatMaster>

<b id="libtokenmarkers">[7]:</b> libTokenMarkers <https://github.com/Roll20/roll20-api-scripts/tree/master/libTokenMarkers>
<b id="combatmaster">[7]:</b> Magic Store <https://github.com/Roll20/roll20-api-scripts/tree/master/CombatMaster>


2 CombatMaster
3 libTokenMarkers
4 Magic Store v2.0.0
5 Multi-World Calendar v6.2.0
6 Teleport

<b id="tokenmod">[7]:</b> TokenMod <https://github.com/Roll20/roll20-api-scripts/tree/master/TokenMod>

* If it does not work copy/paste failsafe code.

Back to List [⬆️](#macros)

Intent

Using a character sheet is a Roll20 trick for managing macros. Tools such as the transmogrifier only allow moving Pages, Characters, Decks, Handouts , Rolltables, and Jukeboxplaylist.
...
Using the VTT Enhancement Suite global macros can be exported/imported as JSON files. Extremely handed tool (no subscription needed).
...
C. Transmogrifier You are game creator and are a Roll20 Subscriber. As mentioned earlier the Roll20 migration tool, transmogrifier, will move characters from one game to another that you are own.
