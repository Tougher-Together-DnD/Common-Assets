...
JSON Hard copy: [Language: Goblin](https://github.com/Tougher-Together-DnD/common-assets/blob/main/Special%20Setup/Languages/Character%20Sheets/Language%20Goblin.json)
...
### Script
Goblin is writtin in Dethek, but more recently goblins and hobgoblins have begun using the Thorass script.
