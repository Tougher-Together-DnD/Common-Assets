# Intro
*First line seen in LFG... get that attention*

*Set up the conflict and atmosphere* [Google](https://www.google.com)

**Can YOU the adventurer make a difference?**

***
# Welcome Adventurers!
Read through the Game Description. If interested in playing, Post in the **"APPLY HERE"** Forum Topic.

***NOTE: Any module differences.***
...
### Character Creation:
* Once invited, you can access a link to "Tougher Together's Character Creation Server" in the **"Recent Game Discussion"** Forum. 

* Your Character can be constructed using game material found in: **Dungeon Master's Guide, Player's Handbook, Elemental Evil Player's Companion, Volvo's Guide to Monsters, Xanathar's Guide to Everything, Mordenkainen's Tome of Foes**

  Additional Backgrounds or allowed options:
...
* [BANNED] Stuff like flying races or Unearthed Arcana banned from being used.
